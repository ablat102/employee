...
<div style="margin:0 60px;">
    ...
    <table class="table-user">
        ...
        <tr>
            <td><label>机器地址：</label><input type="text" placeholder="请输入机器地址" name="machineLocation" class="machineLocation"/></td>
            <td><label>放置时间：</label><input type="text" placeholder="请输入机器的放置时间，如2017-12-20" name="machineDate" class="date" id="d12"/><i onclick="WdatePicker({el:'d12'})"></i></td>
        </tr>
